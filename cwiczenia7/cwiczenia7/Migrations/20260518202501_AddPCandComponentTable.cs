...
{
    /// <inheritdoc />
    public partial class AddPCandComponentTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdManufacurer = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_ComponentManufacturers_IdManufacurer",
                        column: x => x.IdManufacurer,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Components_IdManufacurer",
                table: "Components",
                column: "IdManufacurer");
        }
